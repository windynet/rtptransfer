        ...
        public void run() {
            ...
            if (active) {
                ...
                while (it.hasNext() && active) {
                    ...
                    logger.debug( "Select Polling !!!!!" );
                    try {
                        if (attachment instanceof ProtocolHandler) {
                            logger.debug( "MGCP channel !!!!!" );
                            // Legacy - MGCP channel
                            ...
                            // do read
                            if (key.isValid()) {
                                logger.debug( "Key Is Valid 31311131c !!!!!" );
...
//
//                                    udpChannel.receive( recvBuff );

                                    this.buffer.get( recvbuffer );
//
                                    logger.debug( "MGCP channel !!!!!" + byteArrayToHex( recvbuffer ) );
                            }
