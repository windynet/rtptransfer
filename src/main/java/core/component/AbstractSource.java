...
public abstract class AbstractSource extends BaseComponent implements MediaSource {
  ...
  //duration of media stream in nanoseconds
     ...
     * (Non Java-doc.)
     * 
     * @see core.component.AbstractSource#setInitialDelay(long) 
     */
     ...
     * (Non Java-doc).
     *
     * @see core.spi.MediaSource#connect(MediaSink)
     * @param sink
     */
     ...
     * (Non Java-doc).
     *
     * @see core.spi.MediaSource#disconnect(org.mobicents.server.spi.io.Pipe)
     */
     ...
     * (Non Java-doc).
     * 
     * @see core.spi.MediaSource#getPacketsReceived()
     */
     ...
     * (Non Java-doc).
     * 
     * @see core.spi.MediaSource#getBytesTransmitted()
     */
